...
public class ControllerUtils {
    ...
    public static <T> ApiResponse<T> ok(T data) {
        return new ApiResponse<>(200, ApiResponse.StatusCode.OK, "success", data);
    }

    public static <T> ApiResponse<T> five00(String message) {
        return new ApiResponse<>(500, ApiResponse.StatusCode.INTERNAL_SERVER_ERROR, message, null);
    }

    public static <T> ApiResponse<T> four00(String message) {
        return new ApiResponse<>(400, ApiResponse.StatusCode.BAD_REQUEST, message, null);
    }
}
